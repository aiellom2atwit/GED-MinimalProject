...
void Animation::update(){
    ...
    //TODO: Calculate the current frame to be displayed and set the raylib rect so that it shows the correct frame
    int animFrame = (currentFrame / speed) % frameCount;
    frameRect.x = animFrame * size.x;
}
